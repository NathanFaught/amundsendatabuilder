...
if __name__ == "__main__":
    ...
    if create_connection(DB_FILE):
        ...
        #run_csv_job('example/sample_data/x_sample_application.csv', 'test_application_metadata',
        ...
        #run_csv_job('example/sample_data/3_schema_description.csv', 'test_schema_description',
