...
def connection_string():
    ...
    port = '5432'
    db = 'TestDB'
    params = urllib.parse.quote_plus("DRIVER={/opt/microsoft/msodbcsql17/lib64/libmsodbcsql-17.5.so.2.1};SERVER=%s,%s;DATABASE=%s;UID=%s;PWD=%s" % (host,port,db,user,passwd))
